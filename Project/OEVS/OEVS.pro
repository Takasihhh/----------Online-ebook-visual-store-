...
LIBS += C:/OEVS/----------Online-ebook-visual-store-/Project/OEVS/SDK/MaterialSDK/staticlib/libcomponents.a
INCLUDEPATH += C:/OEVS/----------Online-ebook-visual-store-/Project/OEVS/SDK/MaterialSDK/components
PRE_TARGETDEPS += C:/OEVS/----------Online-ebook-visual-store-/Project/OEVS/SDK/MaterialSDK/staticlib/libcomponents.a
