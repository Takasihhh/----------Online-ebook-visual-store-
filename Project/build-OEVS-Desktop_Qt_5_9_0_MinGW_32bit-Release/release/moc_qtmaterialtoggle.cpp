...
#include "../../OEVS/SDK/MaterialSDK/components/qtmaterialtoggle.h"
...
void QtMaterialToggle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        QtMaterialToggle *_t = static_cast<QtMaterialToggle *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
const QMetaObject QtMaterialToggle::staticMetaObject = {
    { &QAbstractButton::staticMetaObject, qt_meta_stringdata_QtMaterialToggle.data,
      qt_meta_data_QtMaterialToggle,  qt_static_metacall, nullptr, nullptr}
};
...
void *QtMaterialToggle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtMaterialToggle.stringdata0))
        return static_cast<void*>(const_cast< QtMaterialToggle*>(this));
