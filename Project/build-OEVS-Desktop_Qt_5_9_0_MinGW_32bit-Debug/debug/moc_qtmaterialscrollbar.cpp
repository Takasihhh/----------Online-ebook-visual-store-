...
#include "../../OEVS/SDK/MaterialSDK/components/qtmaterialscrollbar.h"
...
void QtMaterialScrollBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        QtMaterialScrollBar *_t = static_cast<QtMaterialScrollBar *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
const QMetaObject QtMaterialScrollBar::staticMetaObject = {
    { &QScrollBar::staticMetaObject, qt_meta_stringdata_QtMaterialScrollBar.data,
      qt_meta_data_QtMaterialScrollBar,  qt_static_metacall, nullptr, nullptr}
};
...
void *QtMaterialScrollBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtMaterialScrollBar.stringdata0))
        return static_cast<void*>(const_cast< QtMaterialScrollBar*>(this));
