...
#include "../../OEVS/SDK/MaterialSDK/components/qtmaterialappbar.h"
...
void QtMaterialAppBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        QtMaterialAppBar *_t = static_cast<QtMaterialAppBar *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
const QMetaObject QtMaterialAppBar::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QtMaterialAppBar.data,
      qt_meta_data_QtMaterialAppBar,  qt_static_metacall, nullptr, nullptr}
};
...
void *QtMaterialAppBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtMaterialAppBar.stringdata0))
        return static_cast<void*>(const_cast< QtMaterialAppBar*>(this));
